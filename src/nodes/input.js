        ...
        if (this.outputs) {
            for (var i = 0; i < this.outputs.length; i++) {
                ...
                if (gamepad) {
                    switch (output.name) {
                        case "left_axis":
                            v = [gamepad.xbox.axes["lx"], gamepad.xbox.axes["ly"]];
                            break;
                        case "right_axis":
                            v = [gamepad.xbox.axes["rx"], gamepad.xbox.axes["ry"]];
                            break;
                        case "left_x_axis":
                            v = gamepad.xbox.axes["lx"];
                            break;
                        case "left_y_axis":
                            v = gamepad.xbox.axes["ly"];
                            break;
                        case "right_x_axis":
                            v = gamepad.xbox.axes["rx"];
                            break;
                        case "right_y_axis":
                            v = gamepad.xbox.axes["ry"];
                            break;
                        case "trigger_left":
                            v = gamepad.xbox.axes["ltrigger"];
                            break;
                        case "trigger_right":
                            v = gamepad.xbox.axes["rtrigger"];
                            break;
                        case "a_button":
